...
class AccountAsset(models.Model):
    ...
    new_location_id = fields.Many2one(string="Nouvel emplacement", comodel_name="stock.location")
    ...
    present = fields.Boolean(string="Est présent", default=False, readonly=True)